package ru.producer.endpoints;

import com.produce.ws.*;
...
import ru.producer.service.IArticleService;
...
public class ArticleEndpoint {
    private static final String NAMESPACE_URI = "http://www.produce.com/article-ws";
